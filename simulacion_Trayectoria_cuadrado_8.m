...
v = [1*ones(1,10) 0*ones(1,10)    1*ones(1,10) 0*ones(1,10)    1*ones(1,10) 0*ones(1,10)    1*ones(1,10) 0*ones(1,11)]; % Velocidad lineal de referencia (m/s)
w = [0*ones(1,10) pi/2*ones(1,10) 0*ones(1,10) pi/2*ones(1,10) 0*ones(1,10) pi/2*ones(1,10) 0*ones(1,10) pi/2*ones(1,11)]; % Velocidad angular de referencia (rad/s)
